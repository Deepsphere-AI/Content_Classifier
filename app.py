...
imcol1, imcol2, imcol3 = st.columns((2.8,5,3))
with imcol1:
    st.write("")
with imcol2:
...
with imcol3:
    st.write("")
st.markdown("<p style='text-align: center; color: black; font-size:23px;'><span style='font-weight: bold'>Content Classifier: </span>Determine Whether the Content is Written by Humans or Generated by AI <br>Regardless of Content Source and Size</p>", unsafe_allow_html=True)
